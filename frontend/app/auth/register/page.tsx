...
import { Eye, EyeOff, Package, Loader2, Mail, Lock, User, Building, Phone } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    try {
      ...
      // Remove the terms field and prepare data for API
        ...
        <Card className="w-full">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Join thousands of professionals using RentalPro
            </CardDescription>
          </CardHeader>
